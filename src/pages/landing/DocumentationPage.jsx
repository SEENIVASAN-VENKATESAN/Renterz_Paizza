        ...
        <div className="grid gap-4 lg:grid-cols-[230px_minmax(0,1fr)]">
          ...
          <section className="space-y-4">
            <article id="overview" className="card p-5">
              ...
              <p className="mt-2 text-sm text-soft">
                This app now supports a multi-tenant SaaS frontend model using JWT claims for role and building context, with a single login page and single registration page.
              </p>
            </article>
            ...
            <article id="auth" className="card p-5">
              ...
              <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-soft">
                ...
                <li>`/auth/me` is used to sync profile and building status.</li>
            ...
            <article id="api" className="card p-5">
              ...
              <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-soft">
                ...
                <li>`POST /auth/register` (building admin self-registration)</li>
                <li>`GET /auth/me`</li>
                <li>`GET /super-admin/buildings`</li>
                <li>`POST /super-admin/buildings`</li>
                <li>`PATCH /super-admin/buildings/:id/status`</li>
                <li>`GET /building-admin/users`</li>
                <li>`POST /building-admin/users`</li>
                <li>`DELETE /building-admin/users/:id`</li>
                <li>`POST /building-admin/users/:id/reset-password`</li>
              </ul>
            </article>
...
AuthContext (sessionStorage + token checks)
    |
    +--> GET /auth/me (building status sync)
    |
    v
Role Home Redirect
    |
