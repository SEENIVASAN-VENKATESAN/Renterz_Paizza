...
export const NAV_ITEMS = [
  ...
  { label: 'Units', to: '/units', icon: LayoutGrid, roles: [ROLES.BUILDING_ADMIN] },
...
export const EXTRA_NAV_ITEMS = [
  ...
  { label: 'Damage Reports', to: '/damage-reports', roles: [ROLES.BUILDING_ADMIN, ROLES.TENANT] },
  { label: 'Communication', to: '/communication', roles: [ROLES.BUILDING_ADMIN, ROLES.TENANT] },
]
