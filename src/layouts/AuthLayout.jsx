...
export default function AuthLayout() {
  return (
    <div className="auth-layout-shell auth-page-bg flex min-h-screen items-center justify-center p-4">
      <div className="auth-layout-card grid w-full max-w-5xl overflow-hidden rounded-3xl border border-white/20 bg-white/95 shadow-2xl backdrop-blur-sm lg:grid-cols-2">
        ...
        <section className="auth-layout-form bg-white/94 p-6 text-main md:p-8">
          <Outlet />
        </section>
      </div>
    </div>
